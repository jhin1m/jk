...
const lines = [
  ...
  '',
  '## jk mức việc (tự suy ra từ thay đổi, không cần cờ)',
  '- **S**: ≤ 2 file · không đổi contract công khai · không chạm auth/tiền/dữ liệu/migration.',
  '- **M**: 3–8 file, hoặc đổi contract nội bộ, hoặc chạm logic nghiệp vụ.',
  '- **L**: > 8 file, hoặc đổi contract công khai, hoặc chạm auth/thanh toán/dữ liệu người dùng/migration/hạ tầng.',
  '- Một dòng sửa trong vùng L vẫn là L. Mức quyết định độ sâu kiểm chứng và có gọi agent hay không — chi tiết ở skill đang chạy.',
  '',
  '## jk quy tắc',
  ...
  '- Làm đủ mức, không làm quá: đã chạy lệnh kiểm chứng trong phiên và từ đó chỉ đổi thứ không ảnh hưởng tới nó → nêu lại kết quả cũ kèm thời điểm, không chạy lại.',
